...
}`;function Op(i,e,t){let n=new pa;const s=new Fe,r=new Fe,a=new lt,o=new sh({depthPacking:dc}),l=new rh,c={},h=t.maxTextureSize,u={[Mn]:bt,[bt]:Mn,[nn]:nn},f=new Sn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Fe},radius:{value:4}},vertexShader:Np,fragmentShader:Fp}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new zt;_.setAttribute("position",new Ot(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new an(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Vo;let d=this.type;this.render=function(w,b,L){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const S=i.getRenderTarget(),M=i.getActiveCubeFace(),P=i.getActiveMipmapLevel(),X=i.state;X.setBlending(vn),X.buffers.color.setClear(1,1,1,1),X.buffers.depth.setTest(!0),X.setScissorTest(!1);const V=d!==tn&&this.type===tn,j=d===tn&&this.type!==tn;for(let G=0,k=w.length;G<k;G++){const q=w[G],O=q.shadow;if(O===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(O.autoUpdate===!1&&O.needsUpdate===!1)continue;s.copy(O.mapSize);const Q=O.getFrameExtents();if(s.multiply(Q),r.copy(O.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/Q.x),s.x=r.x*Q.x,O.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/Q.y),s.y=r.y*Q.y,O.mapSize.y=r.y)),O.map===null||V===!0||j===!0){const fe=this.type!==tn?{minFilter:Xt,magFilter:Xt}:{};O.map!==null&&O.map.dispose(),O.map=new Bn(s.x,s.y,fe),O.map.texture.name=q.name+".shadowMap",O.camera.updateProjectionMatrix()}i.setRenderTarget(O.map),i.clear();const ae=O.getViewportCount();for(let fe=0;fe<ae;fe++){const Pe=O.getViewport(fe);a.set(r.x*Pe.x,r.y*Pe.y,r.x*Pe.z,r.y*Pe.w),X.viewport(a),O.updateMatrices(q,fe),n=O.getFrustum(),E(b,L,O.camera,q,this.type)}O.isPointLightShadow!==!0&&this.type===tn&&A(O,L),O.needsUpdate=!1}d=this.type,m.needsUpdate=!1,i.setRenderTarget(S,M,P)};function A(w,b){const L=e.update(v);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Bn(s.x,s.y)),f.uniforms.shadow_pass.value=w.map.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(b,null,L,f,v,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(b,null,L,p,v,null)}function T(w,b,L,S){let M=null;const P=L.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(P!==void 0)M=P;else if(M=L.isPointLight===!0?l:o,i.localClippingEnabled&&b.clipShadows===!0&&Array.isArray(b.clippingPlanes)&&b.clippingPlanes.length!==0||b.displacementMap&&b.displacementScale!==0||b.alphaMap&&b.alphaTest>0||b.map&&b.alphaTest>0||b.alphaToCoverage===!0){const X=M.uuid,V=b.uuid;let j=c[X];j===void 0&&(j={},c[X]=j);let G=j[V];G===void 0&&(G=M.clone(),j[V]=G,b.addEventListener("dispose",C)),M=G}if(M.visible=b.visible,M.wireframe=b.wireframe,S===tn?M.side=b.shadowSide!==null?b.shadowSide:b.side:M.side=b.shadowSide!==null?b.shadowSide:u[b.side],M.alphaMap=b.alphaMap,M.alphaTest=b.alphaToCoverage===!0?.5:b.alphaTest,M.map=b.map,M.clipShadows=b.clipShadows,M.clippingPlanes=b.clippingPlanes,M.clipIntersection=b.clipIntersection,M.displacementMap=b.displacementMap,M.displacementScale=b.displacementScale,M.displacementBias=b.displacementBias,M.wireframeLinewidth=b.wireframeLinewidth,M.linewidth=b.linewidth,L.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const X=i.properties.get(M);X.light=L}return M}function E(w,b,L,S,M){if(w.visible===!1)return;if(w.layers.test(b.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&M===tn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(L.matrixWorldInverse,w.matrixWorld);const V=e.update(w),j=w.material;if(Array.isArray(j)){const G=V.groups;for(let k=0,q=G.length;k<q;k++){const O=G[k],Q=j[O.materialIndex];if(Q&&Q.visible){const ae=T(w,Q,S,M);w.onBeforeShadow(i,w,b,L,V,ae,O),i.renderBufferDirect(L,null,V,ae,w,O),w.onAfterShadow(i,w,b,L,V,ae,O)}}}else if(j.visible){const G=T(w,j,S,M);w.onBeforeShadow(i,w,b,L,V,G,null),i.renderBufferDirect(L,null,V,G,w,null),w.onAfterShadow(i,w,b,L,V,G,null)}}const X=w.children;for(let V=0,j=X.length;V<j;V++)E(X[V],b,L,S,M)}function C(w){w.target.removeEventListener("dispose",C);for(const L in c){const S=c[L],M=w.target.uuid;M in S&&(S[M].dispose(),delete S[M])}}}const Bp={[xr]:Mr,[Sr]:Tr,[Er]:br,[ci]:yr,[Mr]:xr,[Tr]:Sr,[br]:Er,[yr]:ci};function zp(i,e){function t(){let D=!1;const ce=new lt;let ee=null;const pe=new lt(0,0,0,0);return{setMask:function(te){ee!==te&&!D&&(i.colorMask(te,te,te,te),ee=te)},setLocked:function(te){D=te},setClear:function(te,$,me,Ue,nt){nt===!0&&(te*=Ue,$*=Ue,me*=Ue),ce.set(te,$,me,Ue),pe.equals(ce)===!1&&(i.clearColor(te,$,me,Ue),pe.copy(ce))},reset:function(){D=!1,ee=null,pe.set(-1,0,0,0)}}}function n(){let D=!1,ce=!1,ee=null,pe=null,te=null;return{setReversed:function($){if(ce!==$){const me=e.get("EXT_clip_control");$?me.clipControlEXT(me.LOWER_LEFT_EXT,me.ZERO_TO_ONE_EXT):me.clipControlEXT(me.LOWER_LEFT_EXT,me.NEGATIVE_ONE_TO_ONE_EXT),ce=$;const Ue=te;te=null,this.setClear(Ue)}},getReversed:function(){return ce},setTest:function($){$?le(i.DEPTH_TEST):xe(i.DEPTH_TEST)},setMask:function($){ee!==$&&!D&&(i.depthMask($),ee=$)},setFunc:function($){if(ce&&($=Bp[$]),pe!==$){switch($){case xr:i.depthFunc(i.NEVER);break;case Mr:i.depthFunc(i.ALWAYS);break;case Sr:i.depthFunc(i.LESS);break;case ci:i.depthFunc(i.LEQUAL);break;case Er:i.depthFunc(i.EQUAL);break;case yr:i.depthFunc(i.GEQUAL);break;case Tr:i.depthFunc(i.GREATER);break;case br:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=$}},setLocked:function($){D=$},setClear:function($){te!==$&&(ce&&($=1-$),i.clearDepth($),te=$)},reset:function(){D=!1,ee=null,pe=null,te=null,ce=!1}}}function s(){let D=!1,ce=null,ee=null,pe=null,te=null,$=null,me=null,Ue=null,nt=null;return{setTest:function(Ke){D||(Ke?le(i.STENCIL_TEST):xe(i.STENCIL_TEST))},setMask:function(Ke){ce!==Ke&&!D&&(i.stencilMask(Ke),ce=Ke)},setFunc:function(Ke,Ht,$t){(ee!==Ke||pe!==Ht||te!==$t)&&(i.stencilFunc(Ke,Ht,$t),ee=Ke,pe=Ht,te=$t)},setOp:function(Ke,Ht,$t){($!==Ke||me!==Ht||Ue!==$t)&&(i.stencilOp(Ke,Ht,$t),$=Ke,me=Ht,Ue=$t)},setLocked:function(Ke){D=Ke},setClear:function(Ke){nt!==Ke&&(i.clearStencil(Ke),nt=Ke)},reset:function(){D=!1,ce=null,ee=null,pe=null,te=null,$=null,me=null,Ue=null,nt=null}}}const r=new t,a=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},u={},f=new WeakMap,p=[],_=null,v=!1,m=null,d=null,A=null,T=null,E=null,C=null,w=null,b=new ze(0,0,0),L=0,S=!1,M=null,P=null,X=null,V=null,j=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let k=!1,q=0;const O=i.getParameter(i.VERSION);O.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(O)[1]),k=q>=1):O.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(O)[1]),k=q>=2);let Q=null,ae={};const fe=i.getParameter(i.SCISSOR_BOX),Pe=i.getParameter(i.VIEWPORT),Ge=new lt().fromArray(fe),Y=new lt().fromArray(Pe);function ie(D,ce,ee,pe){const te=new Uint8Array(4),$=i.createTexture();i.bindTexture(D,$),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let me=0;me<ee;me++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(ce,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,te):i.texImage2D(ce+me,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,te);return $}const ve={};ve[i.TEXTURE_2D]=ie(i.TEXTURE_2D,i.TEXTURE_2D,1),ve[i.TEXTURE_CUBE_MAP]=ie(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),ve[i.TEXTURE_2D_ARRAY]=ie(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),ve[i.TEXTURE_3D]=ie(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),le(i.DEPTH_TEST),a.setFunc(ci),Ye(!1),tt(wa),le(i.CULL_FACE),R(vn);function le(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function xe(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function ke(D,ce){return u[D]!==ce?(i.bindFramebuffer(D,ce),u[D]=ce,D===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ce),D===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ce),!0):!1}function Ae(D,ce){let ee=p,pe=!1;if(D){ee=f.get(ce),ee===void 0&&(ee=[],f.set(ce,ee));const te=D.textures;if(ee.length!==te.length||ee[0]!==i.COLOR_ATTACHMENT0){for(let $=0,me=te.length;$<me;$++)ee[$]=i.COLOR_ATTACHMENT0+$;ee.length=te.length,pe=!0}}else ee[0]!==i.BACK&&(ee[0]=i.BACK,pe=!0);pe&&i.drawBuffers(ee)}function Qe(D){return _!==D?(i.useProgram(D),_=D,!0):!1}const et={[Dn]:i.FUNC_ADD,[Bl]:i.FUNC_SUBTRACT,[zl]:i.FUNC_REVERSE_SUBTRACT};et[Hl]=i.MIN,et[Gl]=i.MAX;const Ie={[Vl]:i.ZERO,[kl]:i.ONE,[Wl]:i.SRC_COLOR,[gr]:i.SRC_ALPHA,[jl]:i.SRC_ALPHA_SATURATE,[Kl]:i.DST_COLOR,[ql]:i.DST_ALPHA,[Xl]:i.ONE_MINUS_SRC_COLOR,[vr]:i.ONE_MINUS_SRC_ALPHA,[$l]:i.ONE_MINUS_DST_COLOR,[Yl]:i.ONE_MINUS_DST_ALPHA,[Zl]:i.CONSTANT_COLOR,[Jl]:i.ONE_MINUS_CONSTANT_COLOR,[Ql]:i.CONSTANT_ALPHA,[ec]:i.ONE_MINUS_CONSTANT_ALPHA};function R(D,ce,ee,pe,te,$,me,Ue,nt,Ke){if(D===vn){v===!0&&(xe(i.BLEND),v=!1);return}if(v===!1&&(le(i.BLEND),v=!0),D!==Ol){if(D!==m||Ke!==S){if((d!==Dn||E!==Dn)&&(i.blendEquation(i.FUNC_ADD),d=Dn,E=Dn),Ke)switch(D){case ai:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ra:i.blendFunc(i.ONE,i.ONE);break;case Ca:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Pa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case ai:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ra:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ca:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Pa:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}A=null,T=null,C=null,w=null,b.set(0,0,0),L=0,m=D,S=Ke}return}te=te||ce,$=$||ee,me=me||pe,(ce!==d||te!==E)&&(i.blendEquationSeparate(et[ce],et[te]),d=ce,E=te),(ee!==A||pe!==T||$!==C||me!==w)&&(i.blendFuncSeparate(Ie[ee],Ie[pe],Ie[$],Ie[me]),A=ee,T=pe,C=$,w=me),(Ue.equals(b)===!1||nt!==L)&&(i.blendColor(Ue.r,Ue.g,Ue.b,nt),b.copy(Ue),L=nt),m=D,S=!1}function xt(D,ce){D.side===nn?xe(i.CULL_FACE):le(i.CULL_FACE);let ee=D.side===bt;ce&&(ee=!ee),Ye(ee),D.blending===ai&&D.transparent===!1?R(vn):R(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),a.setFunc(D.depthFunc),a.setTest(D.depthTest),a.setMask(D.depthWrite),r.setMask(D.colorWrite);const pe=D.stencilWrite;o.setTest(pe),pe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),We(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?le(i.SAMPLE_ALPHA_TO_COVERAGE):xe(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ye(D){M!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),M=D)}function tt(D){D!==Ul?(le(i.CULL_FACE),D!==P&&(D===wa?i.cullFace(i.BACK):D===Nl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):xe(i.CULL_FACE),P=D}function Me(D){D!==X&&(k&&i.lineWidth(D),X=D)}function We(D,ce,ee){D?(le(i.POLYGON_OFFSET_FILL),(V!==ce||j!==ee)&&(i.polygonOffset(ce,ee),V=ce,j=ee)):xe(i.POLYGON_OFFSET_FILL)}function Te(D){D?le(i.SCISSOR_TEST):xe(i.SCISSOR_TEST)}function Oe(D){D===void 0&&(D=i.TEXTURE0+G-1),Q!==D&&(i.activeTexture(D),Q=D)}function ht(D,ce,ee){ee===void 0&&(Q===null?ee=i.TEXTURE0+G-1:ee=Q);let pe=ae[ee];pe===void 0&&(pe={type:void 0,texture:void 0},ae[ee]=pe),(pe.type!==D||pe.texture!==ce)&&(Q!==ee&&(i.activeTexture(ee),Q=ee),i.bindTexture(D,ce||ve[D]),pe.type=D,pe.texture=ce)}function y(){const D=ae[Q];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function g(){try{i.compressedTexImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function B(){try{i.compressedTexImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function K(){try{i.texSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Z(){try{i.texSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function W(){try{i.compressedTexSubImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Se(){try{i.compressedTexSubImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function oe(){try{i.texStorage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ge(){try{i.texStorage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ee(){try{i.texImage2D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function J(){try{i.texImage3D(...arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ue(D){Ge.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Ge.copy(D))}function Re(D){Y.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Y.copy(D))}function we(D,ce){let ee=c.get(ce);ee===void 0&&(ee=new WeakMap,c.set(ce,ee));let pe=ee.get(D);pe===void 0&&(pe=i.getUniformBlockIndex(ce,D.name),ee.set(D,pe))}function se(D,ce){const pe=c.get(ce).get(D);l.get(ce)!==pe&&(i.uniformBlockBinding(ce,pe,D.__bindingPointIndex),l.set(ce,pe))}function Le(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},Q=null,ae={},u={},f=new WeakMap,p=[],_=null,v=!1,m=null,d=null,A=null,T=null,E=null,C=null,w=null,b=new ze(0,0,0),L=0,S=!1,M=null,P=null,X=null,V=null,j=null,Ge.set(0,0,i.canvas.width,i.canvas.height),Y.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:le,disable:xe,bindFramebuffer:ke,drawBuffers:Ae,useProgram:Qe,setBlending:R,setMaterial:xt,setFlipSided:Ye,setCullFace:tt,setLineWidth:Me,setPolygonOffset:We,setScissorTest:Te,activeTexture:Oe,bindTexture:ht,unbindTexture:y,compressedTexImage2D:g,compressedTexImage3D:B,texImage2D:Ee,texImage3D:J,updateUBOMapping:we,uniformBlockBinding:se,texStorage2D:oe,texStorage3D:ge,texSubImage2D:K,texSubImage3D:Z,compressedTexSubImage2D:W,compressedTexSubImage3D:Se,scissor:ue,viewport:Re,reset:Le}}function Hp(i,e,t,n,s,r,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Fe,h=new WeakMap;let u;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(y,g){return p?new OffscreenCanvas(y,g):ys("canvas")}function v(y,g,B){let K=1;const Z=ht(y);if((Z.width>B||Z.height>B)&&(K=B/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&y instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&y instanceof ImageBitmap||typeof VideoFrame<"u"&&y instanceof VideoFrame){const W=Math.floor(K*Z.width),Se=Math.floor(K*Z.height);u===void 0&&(u=_(W,Se));const oe=g?_(W,Se):u;return oe.width=W,oe.height=Se,oe.getContext("2d").drawImage(y,0,0,W,Se),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+W+"x"+Se+")."),oe}else return"data"in y&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),y;return y}function m(y){return y.generateMipmaps}function d(y){i.generateMipmap(y)}function A(y){return y.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:y.isWebGL3DRenderTarget?i.TEXTURE_3D:y.isWebGLArrayRenderTarget||y.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function T(y,g,B,K,Z=!1){if(y!==null){if(i[y]!==void 0)return i[y];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+y+"'")}let W=g;if(g===i.RED&&(B===i.FLOAT&&(W=i.R32F),B===i.HALF_FLOAT&&(W=i.R16F),B===i.UNSIGNED_BYTE&&(W=i.R8)),g===i.RED_INTEGER&&(B===i.UNSIGNED_BYTE&&(W=i.R8UI),B===i.UNSIGNED_SHORT&&(W=i.R16UI),B===i.UNSIGNED_INT&&(W=i.R32UI),B===i.BYTE&&(W=i.R8I),B===i.SHORT&&(W=i.R16I),B===i.INT&&(W=i.R32I)),g===i.RG&&(B===i.FLOAT&&(W=i.RG32F),B===i.HALF_FLOAT&&(W=i.RG16F),B===i.UNSIGNED_BYTE&&(W=i.RG8)),g===i.RG_INTEGER&&(B===i.UNSIGNED_BYTE&&(W=i.RG8UI),B===i.UNSIGNED_SHORT&&(W=i.RG16UI),B===i.UNSIGNED_INT&&(W=i.RG32UI),B===i.BYTE&&(W=i.RG8I),B===i.SHORT&&(W=i.RG16I),B===i.INT&&(W=i.RG32I)),g===i.RGB_INTEGER&&(B===i.UNSIGNED_BYTE&&(W=i.RGB8UI),B===i.UNSIGNED_SHORT&&(W=i.RGB16UI),B===i.UNSIGNED_INT&&(W=i.RGB32UI),B===i.BYTE&&(W=i.RGB8I),B===i.SHORT&&(W=i.RGB16I),B===i.INT&&(W=i.RGB32I)),g===i.RGBA_INTEGER&&(B===i.UNSIGNED_BYTE&&(W=i.RGBA8UI),B===i.UNSIGNED_SHORT&&(W=i.RGBA16UI),B===i.UNSIGNED_INT&&(W=i.RGBA32UI),B===i.BYTE&&(W=i.RGBA8I),B===i.SHORT&&(W=i.RGBA16I),B===i.INT&&(W=i.RGBA32I)),g===i.RGB&&B===i.UNSIGNED_INT_5_9_9_9_REV&&(W=i.RGB9_E5),g===i.RGBA){const Se=Z?Ss:qe.getTransfer(K);B===i.FLOAT&&(W=i.RGBA32F),B===i.HALF_FLOAT&&(W=i.RGBA16F),B===i.UNSIGNED_BYTE&&(W=Se===je?i.SRGB8_ALPHA8:i.RGBA8),B===i.UNSIGNED_SHORT_4_4_4_4&&(W=i.RGBA4),B===i.UNSIGNED_SHORT_5_5_5_1&&(W=i.RGB5_A1)}return(W===i.R16F||W===i.R32F||W===i.RG16F||W===i.RG32F||W===i.RGBA16F||W===i.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function E(y,g){let B;return y?g===null||g===Fn||g===Ri?B=i.DEPTH24_STENCIL8:g===sn?B=i.DEPTH32F_STENCIL8:g===wi&&(B=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):g===null||g===Fn||g===Ri?B=i.DEPTH_COMPONENT24:g===sn?B=i.DEPTH_COMPONENT32F:g===wi&&(B=i.DEPTH_COMPONENT16),B}function C(y,g){return m(y)===!0||y.isFramebufferTexture&&y.minFilter!==Xt&&y.minFilter!==Yt?Math.log2(Math.max(g.width,g.height))+1:y.mipmaps!==void 0&&y.mipmaps.length>0?y.mipmaps.length:y.isCompressedTexture&&Array.isArray(y.image)?g.mipmaps.length:1}function w(y){const g=y.target;g.removeEventListener("dispose",w),L(g),g.isVideoTexture&&h.delete(g)}function b(y){const g=y.target;g.removeEventListener("dispose",b),M(g)}function L(y){const g=n.get(y);if(g.__webglInit===void 0)return;const B=y.source,K=f.get(B);if(K){const Z=K[g.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&S(y),Object.keys(K).length===0&&f.delete(B)}n.remove(y)}function S(y){const g=n.get(y);i.deleteTexture(g.__webglTexture);const B=y.source,K=f.get(B);delete K[g.__cacheKey],a.memory.textures--}function M(y){const g=n.get(y);if(y.depthTexture&&(y.depthTexture.dispose(),n.remove(y.depthTexture)),y.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(g.__webglFramebuffer[K]))for(let Z=0;Z<g.__webglFramebuffer[K].length;Z++)i.deleteFramebuffer(g.__webglFramebuffer[K][Z]);else i.deleteFramebuffer(g.__webglFramebuffer[K]);g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer[K])}else{if(Array.isArray(g.__webglFramebuffer))for(let K=0;K<g.__webglFramebuffer.length;K++)i.deleteFramebuffer(g.__webglFramebuffer[K]);else i.deleteFramebuffer(g.__webglFramebuffer);if(g.__webglDepthbuffer&&i.deleteRenderbuffer(g.__webglDepthbuffer),g.__webglMultisampledFramebuffer&&i.deleteFramebuffer(g.__webglMultisampledFramebuffer),g.__webglColorRenderbuffer)for(let K=0;K<g.__webglColorRenderbuffer.length;K++)g.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(g.__webglColorRenderbuffer[K]);g.__webglDepthRenderbuffer&&i.deleteRenderbuffer(g.__webglDepthRenderbuffer)}const B=y.textures;for(let K=0,Z=B.length;K<Z;K++){const W=n.get(B[K]);W.__webglTexture&&(i.deleteTexture(W.__webglTexture),a.memory.textures--),n.remove(B[K])}n.remove(y)}let P=0;function X(){P=0}function V(){const y=P;return y>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+y+" texture units while this GPU supports only "+s.maxTextures),P+=1,y}function j(y){const g=[];return g.push(y.wrapS),g.push(y.wrapT),g.push(y.wrapR||0),g.push(y.magFilter),g.push(y.minFilter),g.push(y.anisotropy),g.push(y.internalFormat),g.push(y.format),g.push(y.type),g.push(y.generateMipmaps),g.push(y.premultiplyAlpha),g.push(y.flipY),g.push(y.unpackAlignment),g.push(y.colorSpace),g.join()}function G(y,g){const B=n.get(y);if(y.isVideoTexture&&Te(y),y.isRenderTargetTexture===!1&&y.version>0&&B.__version!==y.version){const K=y.image;if(K===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ve(B,y,g);return}}t.bindTexture(i.TEXTURE_2D,B.__webglTexture,i.TEXTURE0+g)}function k(y,g){const B=n.get(y);if(y.version>0&&B.__version!==y.version){ve(B,y,g);return}t.bindTexture(i.TEXTURE_2D_ARRAY,B.__webglTexture,i.TEXTURE0+g)}function q(y,g){const B=n.get(y);if(y.version>0&&B.__version!==y.version){ve(B,y,g);return}t.bindTexture(i.TEXTURE_3D,B.__webglTexture,i.TEXTURE0+g)}function O(y,g){const B=n.get(y);if(y.version>0&&B.__version!==y.version){le(B,y,g);return}t.bindTexture(i.TEXTURE_CUBE_MAP,B.__webglTexture,i.TEXTURE0+g)}const Q={[Rr]:i.REPEAT,[Un]:i.CLAMP_TO_EDGE,[Cr]:i.MIRRORED_REPEAT},ae={[Xt]:i.NEAREST,[hc]:i.NEAREST_MIPMAP_NEAREST,[Oi]:i.NEAREST_MIPMAP_LINEAR,[Yt]:i.LINEAR,[Us]:i.LINEAR_MIPMAP_NEAREST,[Nn]:i.LINEAR_MIPMAP_LINEAR},fe={[mc]:i.NEVER,[Sc]:i.ALWAYS,[_c]:i.LESS,[Qo]:i.LEQUAL,[gc]:i.EQUAL,[Mc]:i.GEQUAL,[vc]:i.GREATER,[xc]:i.NOTEQUAL};function Pe(y,g){if(g.type===sn&&e.has("OES_texture_float_linear")===!1&&(g.magFilter===Yt||g.magFilter===Us||g.magFilter===Oi||g.magFilter===Nn||g.minFilter===Yt||g.minFilter===Us||g.minFilter===Oi||g.minFilter===Nn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(y,i.TEXTURE_WRAP_S,Q[g.wrapS]),i.texParameteri(y,i.TEXTURE_WRAP_T,Q[g.wrapT]),(y===i.TEXTURE_3D||y===i.TEXTURE_2D_ARRAY)&&i.texParameteri(y,i.TEXTURE_WRAP_R,Q[g.wrapR]),i.texParameteri(y,i.TEXTURE_MAG_FILTER,ae[g.magFilter]),i.texParameteri(y,i.TEXTURE_MIN_FILTER,ae[g.minFilter]),g.compareFunction&&(i.texParameteri(y,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(y,i.TEXTURE_COMPARE_FUNC,fe[g.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(g.magFilter===Xt||g.minFilter!==Oi&&g.minFilter!==Nn||g.type===sn&&e.has("OES_texture_float_linear")===!1)return;if(g.anisotropy>1||n.get(g).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");i.texParameterf(y,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(g.anisotropy,s.getMaxAnisotropy())),n.get(g).__currentAnisotropy=g.anisotropy}}}function Ge(y,g){let B=!1;y.__webglInit===void 0&&(y.__webglInit=!0,g.addEventListener("dispose",w));const K=g.source;let Z=f.get(K);Z===void 0&&(Z={},f.set(K,Z));const W=j(g);if(W!==y.__cacheKey){Z[W]===void 0&&(Z[W]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,B=!0),Z[W].usedTimes++;const Se=Z[y.__cacheKey];Se!==void 0&&(Z[y.__cacheKey].usedTimes--,Se.usedTimes===0&&S(g)),y.__cacheKey=W,y.__webglTexture=Z[W].texture}return B}function Y(y,g,B){return Math.floor(Math.floor(y/B)/g)}function ie(y,g,B,K){const W=y.updateRanges;if(W.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,g.width,g.height,B,K,g.data);else{W.sort((J,ue)=>J.start-ue.start);let Se=0;for(let J=1;J<W.length;J++){const ue=W[Se],Re=W[J],we=ue.start+ue.count,se=Y(Re.start,g.width,4),Le=Y(ue.start,g.width,4);Re.start<=we+1&&se===Le&&Y(Re.start+Re.count-1,g.width,4)===se?ue.count=Math.max(ue.count,Re.start+Re.count-ue.start):(++Se,W[Se]=Re)}W.length=Se+1;const oe=i.getParameter(i.UNPACK_ROW_LENGTH),ge=i.getParameter(i.UNPACK_SKIP_PIXELS),Ee=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,g.width);for(let J=0,ue=W.length;J<ue;J++){const Re=W[J],we=Math.floor(Re.start/4),se=Math.ceil(Re.count/4),Le=we%g.width,D=Math.floor(we/g.width),ce=se,ee=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,Le),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,Le,D,ce,ee,B,K,g.data)}y.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,oe),i.pixelStorei(i.UNPACK_SKIP_PIXELS,ge),i.pixelStorei(i.UNPACK_SKIP_ROWS,Ee)}}function ve(y,g,B){let K=i.TEXTURE_2D;(g.isDataArrayTexture||g.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),g.isData3DTexture&&(K=i.TEXTURE_3D);const Z=Ge(y,g),W=g.source;t.bindTexture(K,y.__webglTexture,i.TEXTURE0+B);const Se=n.get(W);if(W.version!==Se.__version||Z===!0){t.activeTexture(i.TEXTURE0+B);const oe=qe.getPrimaries(qe.workingColorSpace),ge=g.colorSpace===gn?null:qe.getPrimaries(g.colorSpace),Ee=g.colorSpace===gn||oe===ge?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let J=v(g.image,!1,s.maxTextureSize);J=Oe(g,J);const ue=r.convert(g.format,g.colorSpace),Re=r.convert(g.type);let we=T(g.internalFormat,ue,Re,g.colorSpace,g.isVideoTexture);Pe(K,g);let se;const Le=g.mipmaps,D=g.isVideoTexture!==!0,ce=Se.__version===void 0||Z===!0,ee=W.dataReady,pe=C(g,J);if(g.isDepthTexture)we=E(g.format===Pi,g.type),ce&&(D?t.texStorage2D(i.TEXTURE_2D,1,we,J.width,J.height):t.texImage2D(i.TEXTURE_2D,0,we,J.width,J.height,0,ue,Re,null));else if(g.isDataTexture)if(Le.length>0){D&&ce&&t.texStorage2D(i.TEXTURE_2D,pe,we,Le[0].width,Le[0].height);for(let te=0,$=Le.length;te<$;te++)se=Le[te],D?ee&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,ue,Re,se.data):t.texImage2D(i.TEXTURE_2D,te,we,se.width,se.height,0,ue,Re,se.data);g.generateMipmaps=!1}else D?(ce&&t.texStorage2D(i.TEXTURE_2D,pe,we,J.width,J.height),ee&&ie(g,J,ue,Re)):t.texImage2D(i.TEXTURE_2D,0,we,J.width,J.height,0,ue,Re,J.data);else if(g.isCompressedTexture)if(g.isCompressedArrayTexture){D&&ce&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,we,Le[0].width,Le[0].height,J.depth);for(let te=0,$=Le.length;te<$;te++)if(se=Le[te],g.format!==Wt)if(ue!==null)if(D){if(ee)if(g.layerUpdates.size>0){const me=ao(se.width,se.height,g.format,g.type);for(const Ue of g.layerUpdates){const nt=se.data.subarray(Ue*me/se.data.BYTES_PER_ELEMENT,(Ue+1)*me/se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,Ue,se.width,se.height,1,ue,nt)}g.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,se.width,se.height,J.depth,ue,se.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,te,we,se.width,se.height,J.depth,0,se.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?ee&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,te,0,0,0,se.width,se.height,J.depth,ue,Re,se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,te,we,se.width,se.height,J.depth,0,ue,Re,se.data)}else{D&&ce&&t.texStorage2D(i.TEXTURE_2D,pe,we,Le[0].width,Le[0].height);for(let te=0,$=Le.length;te<$;te++)se=Le[te],g.format!==Wt?ue!==null?D?ee&&t.compressedTexSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,ue,se.data):t.compressedTexImage2D(i.TEXTURE_2D,te,we,se.width,se.height,0,se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?ee&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,se.width,se.height,ue,Re,se.data):t.texImage2D(i.TEXTURE_2D,te,we,se.width,se.height,0,ue,Re,se.data)}else if(g.isDataArrayTexture)if(D){if(ce&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,we,J.width,J.height,J.depth),ee)if(g.layerUpdates.size>0){const te=ao(J.width,J.height,g.format,g.type);for(const $ of g.layerUpdates){const me=J.data.subarray($*te/J.data.BYTES_PER_ELEMENT,($+1)*te/J.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,$,J.width,J.height,1,ue,Re,me)}g.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,J.width,J.height,J.depth,ue,Re,J.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,we,J.width,J.height,J.depth,0,ue,Re,J.data);else if(g.isData3DTexture)D?(ce&&t.texStorage3D(i.TEXTURE_3D,pe,we,J.width,J.height,J.depth),ee&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,J.width,J.height,J.depth,ue,Re,J.data)):t.texImage3D(i.TEXTURE_3D,0,we,J.width,J.height,J.depth,0,ue,Re,J.data);else if(g.isFramebufferTexture){if(ce)if(D)t.texStorage2D(i.TEXTURE_2D,pe,we,J.width,J.height);else{let te=J.width,$=J.height;for(let me=0;me<pe;me++)t.texImage2D(i.TEXTURE_2D,me,we,te,$,0,ue,Re,null),te>>=1,$>>=1}}else if(Le.length>0){if(D&&ce){const te=ht(Le[0]);t.texStorage2D(i.TEXTURE_2D,pe,we,te.width,te.height)}for(let te=0,$=Le.length;te<$;te++)se=Le[te],D?ee&&t.texSubImage2D(i.TEXTURE_2D,te,0,0,ue,Re,se):t.texImage2D(i.TEXTURE_2D,te,we,ue,Re,se);g.generateMipmaps=!1}else if(D){if(ce){const te=ht(J);t.texStorage2D(i.TEXTURE_2D,pe,we,te.width,te.height)}ee&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ue,Re,J)}else t.texImage2D(i.TEXTURE_2D,0,we,ue,Re,J);m(g)&&d(K),Se.__version=W.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function le(y,g,B){if(g.image.length!==6)return;const K=Ge(y,g),Z=g.source;t.bindTexture(i.TEXTURE_CUBE_MAP,y.__webglTexture,i.TEXTURE0+B);const W=n.get(Z);if(Z.version!==W.__version||K===!0){t.activeTexture(i.TEXTURE0+B);const Se=qe.getPrimaries(qe.workingColorSpace),oe=g.colorSpace===gn?null:qe.getPrimaries(g.colorSpace),ge=g.colorSpace===gn||Se===oe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,g.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,g.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,g.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ge);const Ee=g.isCompressedTexture||g.image[0].isCompressedTexture,J=g.image[0]&&g.image[0].isDataTexture,ue=[];for(let $=0;$<6;$++)!Ee&&!J?ue[$]=v(g.image[$],!0,s.maxCubemapSize):ue[$]=J?g.image[$].image:g.image[$],ue[$]=Oe(g,ue[$]);const Re=ue[0],we=r.convert(g.format,g.colorSpace),se=r.convert(g.type),Le=T(g.internalFormat,we,se,g.colorSpace),D=g.isVideoTexture!==!0,ce=W.__version===void 0||K===!0,ee=Z.dataReady;let pe=C(g,Re);Pe(i.TEXTURE_CUBE_MAP,g);let te;if(Ee){D&&ce&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Le,Re.width,Re.height);for(let $=0;$<6;$++){te=ue[$].mipmaps;for(let me=0;me<te.length;me++){const Ue=te[me];g.format!==Wt?we!==null?D?ee&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me,0,0,Ue.width,Ue.height,we,Ue.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me,Le,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me,0,0,Ue.width,Ue.height,we,se,Ue.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me,Le,Ue.width,Ue.height,0,we,se,Ue.data)}}}else{if(te=g.mipmaps,D&&ce){te.length>0&&pe++;const $=ht(ue[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,Le,$.width,$.height)}for(let $=0;$<6;$++)if(J){D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,ue[$].width,ue[$].height,we,se,ue[$].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Le,ue[$].width,ue[$].height,0,we,se,ue[$].data);for(let me=0;me<te.length;me++){const nt=te[me].image[$].image;D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me+1,0,0,nt.width,nt.height,we,se,nt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me+1,Le,nt.width,nt.height,0,we,se,nt.data)}}else{D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,we,se,ue[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,Le,we,se,ue[$]);for(let me=0;me<te.length;me++){const Ue=te[me];D?ee&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me+1,0,0,we,se,Ue.image[$]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+$,me+1,Le,we,se,Ue.image[$])}}}m(g)&&d(i.TEXTURE_CUBE_MAP),W.__version=Z.version,g.onUpdate&&g.onUpdate(g)}y.__version=g.version}function xe(y,g,B,K,Z,W){const Se=r.convert(B.format,B.colorSpace),oe=r.convert(B.type),ge=T(B.internalFormat,Se,oe,B.colorSpace),Ee=n.get(g),J=n.get(B);if(J.__renderTarget=g,!Ee.__hasExternalTextures){const ue=Math.max(1,g.width>>W),Re=Math.max(1,g.height>>W);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,W,ge,ue,Re,g.depth,0,Se,oe,null):t.texImage2D(Z,W,ge,ue,Re,0,Se,oe,null)}t.bindFramebuffer(i.FRAMEBUFFER,y),We(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Z,J.__webglTexture,0,Me(g)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Z,J.__webglTexture,W),t.bindFramebuffer(i.FRAMEBUFFER,null)}function ke(y,g,B){if(i.bindRenderbuffer(i.RENDERBUFFER,y),g.depthBuffer){const K=g.depthTexture,Z=K&&K.isDepthTexture?K.type:null,W=E(g.stencilBuffer,Z),Se=g.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,oe=Me(g);We(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,oe,W,g.width,g.height):B?i.renderbufferStorageMultisample(i.RENDERBUFFER,oe,W,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,W,g.width,g.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Se,i.RENDERBUFFER,y)}else{const K=g.textures;for(let Z=0;Z<K.length;Z++){const W=K[Z],Se=r.convert(W.format,W.colorSpace),oe=r.convert(W.type),ge=T(W.internalFormat,Se,oe,W.colorSpace),Ee=Me(g);B&&We(g)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,ge,g.width,g.height):We(g)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ee,ge,g.width,g.height):i.renderbufferStorage(i.RENDERBUFFER,ge,g.width,g.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ae(y,g){if(g&&g.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,y),!(g.depthTexture&&g.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const K=n.get(g.depthTexture);K.__renderTarget=g,(!K.__webglTexture||g.depthTexture.image.width!==g.width||g.depthTexture.image.height!==g.height)&&(g.depthTexture.image.width=g.width,g.depthTexture.image.height=g.height,g.depthTexture.needsUpdate=!0),G(g.depthTexture,0);const Z=K.__webglTexture,W=Me(g);if(g.depthTexture.format===Ci)We(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0,W):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,Z,0);else if(g.depthTexture.format===Pi)We(g)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0,W):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,Z,0);else throw new Error("Unknown depthTexture format")}function Qe(y){const g=n.get(y),B=y.isWebGLCubeRenderTarget===!0;if(g.__boundDepthTexture!==y.depthTexture){const K=y.depthTexture;if(g.__depthDisposeCallback&&g.__depthDisposeCallback(),K){const Z=()=>{delete g.__boundDepthTexture,delete g.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),g.__depthDisposeCallback=Z}g.__boundDepthTexture=K}if(y.depthTexture&&!g.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const K=y.texture.mipmaps;K&&K.length>0?Ae(g.__webglFramebuffer[0],y):Ae(g.__webglFramebuffer,y)}else if(B){g.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[K]),g.__webglDepthbuffer[K]===void 0)g.__webglDepthbuffer[K]=i.createRenderbuffer(),ke(g.__webglDepthbuffer[K],y,!1);else{const Z=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,W=g.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,W),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,W)}}else{const K=y.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,g.__webglFramebuffer),g.__webglDepthbuffer===void 0)g.__webglDepthbuffer=i.createRenderbuffer(),ke(g.__webglDepthbuffer,y,!1);else{const Z=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,W=g.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,W),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,W)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function et(y,g,B){const K=n.get(y);g!==void 0&&xe(K.__webglFramebuffer,y,y.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),B!==void 0&&Qe(y)}function Ie(y){const g=y.texture,B=n.get(y),K=n.get(g);y.addEventListener("dispose",b);const Z=y.textures,W=y.isWebGLCubeRenderTarget===!0,Se=Z.length>1;if(Se||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=g.version,a.memory.textures++),W){B.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer[oe]=[];for(let ge=0;ge<g.mipmaps.length;ge++)B.__webglFramebuffer[oe][ge]=i.createFramebuffer()}else B.__webglFramebuffer[oe]=i.createFramebuffer()}else{if(g.mipmaps&&g.mipmaps.length>0){B.__webglFramebuffer=[];for(let oe=0;oe<g.mipmaps.length;oe++)B.__webglFramebuffer[oe]=i.createFramebuffer()}else B.__webglFramebuffer=i.createFramebuffer();if(Se)for(let oe=0,ge=Z.length;oe<ge;oe++){const Ee=n.get(Z[oe]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=i.createTexture(),a.memory.textures++)}if(y.samples>0&&We(y)===!1){B.__webglMultisampledFramebuffer=i.createFramebuffer(),B.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let oe=0;oe<Z.length;oe++){const ge=Z[oe];B.__webglColorRenderbuffer[oe]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,B.__webglColorRenderbuffer[oe]);const Ee=r.convert(ge.format,ge.colorSpace),J=r.convert(ge.type),ue=T(ge.internalFormat,Ee,J,ge.colorSpace,y.isXRRenderTarget===!0),Re=Me(y);i.renderbufferStorageMultisample(i.RENDERBUFFER,Re,ue,y.width,y.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+oe,i.RENDERBUFFER,B.__webglColorRenderbuffer[oe])}i.bindRenderbuffer(i.RENDERBUFFER,null),y.depthBuffer&&(B.__webglDepthRenderbuffer=i.createRenderbuffer(),ke(B.__webglDepthRenderbuffer,y,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(W){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),Pe(i.TEXTURE_CUBE_MAP,g);for(let oe=0;oe<6;oe++)if(g.mipmaps&&g.mipmaps.length>0)for(let ge=0;ge<g.mipmaps.length;ge++)xe(B.__webglFramebuffer[oe][ge],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,ge);else xe(B.__webglFramebuffer[oe],y,g,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(g)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Se){for(let oe=0,ge=Z.length;oe<ge;oe++){const Ee=Z[oe],J=n.get(Ee);t.bindTexture(i.TEXTURE_2D,J.__webglTexture),Pe(i.TEXTURE_2D,Ee),xe(B.__webglFramebuffer,y,Ee,i.COLOR_ATTACHMENT0+oe,i.TEXTURE_2D,0),m(Ee)&&d(i.TEXTURE_2D)}t.unbindTexture()}else{let oe=i.TEXTURE_2D;if((y.isWebGL3DRenderTarget||y.isWebGLArrayRenderTarget)&&(oe=y.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(oe,K.__webglTexture),Pe(oe,g),g.mipmaps&&g.mipmaps.length>0)for(let ge=0;ge<g.mipmaps.length;ge++)xe(B.__webglFramebuffer[ge],y,g,i.COLOR_ATTACHMENT0,oe,ge);else xe(B.__webglFramebuffer,y,g,i.COLOR_ATTACHMENT0,oe,0);m(g)&&d(oe),t.unbindTexture()}y.depthBuffer&&Qe(y)}function R(y){const g=y.textures;for(let B=0,K=g.length;B<K;B++){const Z=g[B];if(m(Z)){const W=A(y),Se=n.get(Z).__webglTexture;t.bindTexture(W,Se),d(W),t.unbindTexture()}}}const xt=[],Ye=[];function tt(y){if(y.samples>0){if(We(y)===!1){const g=y.textures,B=y.width,K=y.height;let Z=i.COLOR_BUFFER_BIT;const W=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Se=n.get(y),oe=g.length>1;if(oe)for(let Ee=0;Ee<g.length;Ee++)t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Se.__webglMultisampledFramebuffer);const ge=y.texture.mipmaps;ge&&ge.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglFramebuffer);for(let Ee=0;Ee<g.length;Ee++){if(y.resolveDepthBuffer&&(y.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),y.stencilBuffer&&y.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),oe){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Se.__webglColorRenderbuffer[Ee]);const J=n.get(g[Ee]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,J,0)}i.blitFramebuffer(0,0,B,K,0,0,B,K,Z,i.NEAREST),l===!0&&(xt.length=0,Ye.length=0,xt.push(i.COLOR_ATTACHMENT0+Ee),y.depthBuffer&&y.resolveDepthBuffer===!1&&(xt.push(W),Ye.push(W),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Ye)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,xt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),oe)for(let Ee=0;Ee<g.length;Ee++){t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.RENDERBUFFER,Se.__webglColorRenderbuffer[Ee]);const J=n.get(g[Ee]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Se.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Ee,i.TEXTURE_2D,J,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Se.__webglMultisampledFramebuffer)}else if(y.depthBuffer&&y.resolveDepthBuffer===!1&&l){const g=y.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[g])}}}function Me(y){return Math.min(s.maxSamples,y.samples)}function We(y){const g=n.get(y);return y.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&g.__useRenderToTexture!==!1}function Te(y){const g=a.render.frame;h.get(y)!==g&&(h.set(y,g),y.update())}function Oe(y,g){const B=y.colorSpace,K=y.format,Z=y.type;return y.isCompressedTexture===!0||y.isVideoTexture===!0||B!==di&&B!==gn&&(qe.getTransfer(B)===je?(K!==Wt||Z!==Kt)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),g}function ht(y){return typeof HTMLImageElement<"u"&&y instanceof HTMLImageElement?(c.width=y.naturalWidth||y.width,c.height=y.naturalHeight||y.height):typeof VideoFrame<"u"&&y instanceof VideoFrame?(c.width=y.displayWidth,c.height=y.displayHeight):(c.width=y.width,c.height=y.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=X,this.setTexture2D=G,this.setTexture2DArray=k,this.setTexture3D=q,this.setTextureCube=O,this.rebindTextures=et,this.setupRenderTarget=Ie,this.updateRenderTargetMipmap=R,this.updateMultisampleRenderTarget=tt,this.setupDepthRenderbuffer=Qe,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=We}function Gp(i,e){function t(n,s=gn){let r;const a=qe.getTransfer(s);if(n===Kt)return i.UNSIGNED_BYTE;if(n===la)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ca)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Yo)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Xo)return i.BYTE;if(n===qo)return i.SHORT;if(n===wi)return i.UNSIGNED_SHORT;if(n===oa)return i.INT;if(n===Fn)return i.UNSIGNED_INT;if(n===sn)return i.FLOAT;if(n===Di)return i.HALF_FLOAT;if(n===Ko)return i.ALPHA;if(n===$o)return i.RGB;if(n===Wt)return i.RGBA;if(n===Ci)return i.DEPTH_COMPONENT;if(n===Pi)return i.DEPTH_STENCIL;if(n===jo)return i.RED;if(n===ha)return i.RED_INTEGER;if(n===Zo)return i.RG;if(n===ua)return i.RG_INTEGER;if(n===da)return i.RGBA_INTEGER;if(n===ms||n===_s||n===gs||n===vs)if(a===je)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===ms)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===ms)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===_s)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===gs)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===vs)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Pr||n===Dr||n===Lr||n===Ir)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Pr)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Dr)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Lr)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ir)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ur||n===Nr||n===Fr)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Ur||n===Nr)return a===je?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Fr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Or||n===Br||n===zr||n===Hr||n===Gr||n===Vr||n===kr||n===Wr||n===Xr||n===qr||n===Yr||n===Kr||n===$r||n===jr)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Or)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Br)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===zr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Hr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Gr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Vr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===kr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Wr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Xr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===qr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Yr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Kr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===$r)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===jr)return a===je?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===xs||n===Zr||n===Jr)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===xs)return a===je?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Zr)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Jr)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Jo||n===Qr||n===ea||n===ta)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===xs)return r.COMPRESSED_RED_RGTC1_EXT;if(n===Qr)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===ea)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===ta)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ri?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Vp=`
void main() {
